/******/ (() => {
  ...
  class DaysView extends View {
      ...
      Array.from(this.grid.children).forEach((el, index) => {
        ...
        if (this.range) {
          ...
          if (current === rangeStart) {
            classList.add("range-start", "bg-blue-700", "dark:bg-gray-600", "rounded-l-lg", "text-white");
            classList.remove("rounded-lg", "rounded-r-lg", "bg-gray-100", "text-gray-900");
          }
          if (current === rangeEnd) {
            classList.add("range-end", "bg-blue-700", "dark:bg-gray-600", "rounded-r-lg", "text-white");
            classList.remove("rounded-lg", "rounded-l-lg", "bg-gray-100", "text-gray-900");
          }
        }
    ...
    refresh() {
      ...
      Array.from(this.grid.children).forEach(el => {
        ...
        if (current === rangeStart) {
          classList.add("range-start", "bg-blue-700", "dark:bg-gray-600", "rounded-l-lg", "text-white");
          classList.remove("rounded-lg", "rounded-r-lg", "bg-gray-200", "text-gray-900");
        }
        if (current === rangeEnd) {
          classList.add("range-end", "bg-blue-700", "dark:bg-gray-600", "rounded-r-lg", "text-white");
          classList.remove("rounded-lg", "rounded-l-lg", "bg-gray-200", "text-gray-900");
        }
        if (this.selected.includes(current)) {
          classList.add("selected", "bg-blue-700", "text-white", "dark:bg-blue-600", "dark:text-white");
  ...
  class Picker {
    constructor(datepicker) {
      ...
      // set up views
      this.views = [new DaysView(this), new MonthsView(this), new YearsView(this, { id: 2, name: "years", cellClass: "year", step: 1 }), new YearsView(this, { id: 3, name: "decades", cellClass: "decade", step: 10 })];
